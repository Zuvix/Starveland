...
public abstract class Talent
{
    ...
    public virtual void Execute(int x, int y, Resource Resource, ResourceSourceGeneric Target) { }
    ...
    public virtual float Execute(ResourceSourceGeneric resourceSource, float value) { return value; }
    public virtual Resource Execute(Resource Resource) { return Resource; }
    public virtual int Execute(Item item) { return 0; }
    public virtual Resource Execute(ResourceSourceGeneric Target, out bool isDepleted) 
    {
        isDepleted = false;
        return null; 
    }
